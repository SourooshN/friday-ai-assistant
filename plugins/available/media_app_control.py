...
class MediaAppControlPlugin:
    ...
    def _get_allowed_operations(self) -> Dict[str, List[str]]:
        ...
        base_safe_ops = [
            "get_media_status", "get_running_applications", "list_installed_applications",
            "get_window_list", "get_active_window", "get_volume_status"
        ]

        base_privileged_ops = [
            "play_media", "pause_media", "stop_media", "next_track", "previous_track",
            "volume_up", "volume_down", "mute_audio", "unmute_audio", "set_volume",
            "launch_application", "close_application", "focus_window", "minimize_window",
            "maximize_window", "close_window"
        ]

        return {
            "safe": base_safe_ops,
            "privileged": base_privileged_ops
        }
        ...
        return {
            ...
            "play_media": {
                ...
                "parameters": {
                    "media_path": {
                        "type": "string",
                        "description": "Optional path to media file to play",
                        "required": False
                    }
                },
            ...
            "volume_up": {
                ...
                "parameters": {
                    "step": {
                        "type": "integer",
                        "description": "Volume increase step (1-10)",
                        "default": 5
                    }
                },
                "security_level": "privileged"
            ...
            "volume_down": {
                ...
                "parameters": {
                    "step": {
                        "type": "integer",
                        "description": "Volume decrease step (1-10)",
                        "default": 5
                    }
                },
                "security_level": "privileged"
            ...
            "get_volume_status": {
                "description": "Get current volume and mute status",
                "parameters": {},
                "security_level": "safe"
            },
            "get_media_status": {
                "description": "Get current media playback status",
                "parameters": {},
                "security_level": "safe"
            },
            ...
            "close_application": {
                ...
                "parameters": {
                    "application": {
                        "type": "string",
                        "description": "Application name or process ID",
                        "required": True
                    },
                    "force": {
                        "type": "boolean",
                        "description": "Force close if application doesn't respond",
                        "default": False
                    }
                },
                "security_level": "privileged"
            ...
            "focus_window": {
                ...
                "parameters": {
                    "window_title": {
                        "type": "string",
                        "description": "Title or partial title of window to focus",
                        "required": True
                    }
                },
                "security_level": "privileged"
            ...
            "minimize_window": {
                ...
                "parameters": {
                    "window_title": {
                        "type": "string",
                        "description": "Title or partial title of window to minimize",
                        "required": True
                    }
                },
                "security_level": "privileged"
            ...
            "maximize_window": {
                ...
                "parameters": {
                    "window_title": {
                        "type": "string",
                        "description": "Title or partial title of window to maximize",
                        "required": True
                    }
                },
                "security_level": "privileged"
            ...
            "close_window": {
                ...
                "parameters": {
                    "window_title": {
                        "type": "string",
                        "description": "Title or partial title of window to close",
                        "required": True
                    }
                },
                "security_level": "privileged"
    ...
    def invoke(self, tool: str, **kwargs) -> Dict[str, Any]:
        ...
        if not self._is_operation_allowed(tool):
            return {
                "success": False,
                "error": f"Operation not allowed: {tool}",
        ...
        try:
            ...
            if tool == "play_media":
                ...
                return {
                    "success": False,
                    "error": f"Tool handler not implemented: {tool}"
                }
    ...
    def _track_operation(self, tool: str, parameters: Dict[str, Any]):
        ...
        if self.memory_manager:
            ...
            self.memory_manager.store_memory(
                memory_id,
                json.dumps(operation_record),
                "media_app_operation",
                {"plugin": self.id, "tool": tool}
            )
    ...
    def _play_media(self, media_path: Optional[str] = None) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                "success": False,
                "error": "Media playback command timed out"
            }
        except Exception as e:
            return {
                "success": False,
                "error": f"Failed to play media: {str(e)}"
            }
    ...
    def _pause_media(self) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                "success": False,
                "error": f"Failed to pause media: {str(e)}"
            }
    ...
    def _stop_media(self) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                "success": False,
                "error": f"Failed to stop media: {str(e)}"
            }
    ...
    def _previous_track(self) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                "success": False,
                "error": f"Failed to go to previous track: {str(e)}"
            }
    ...
    def _volume_up(self, step: int = 5) -> Dict[str, Any]:
        ...
        if not 1 <= step <= 10:
            return {
                "success": False,
                "error": "Volume step must be between 1 and 10"
            }
    ...
    def _mute_audio(self) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                "success": False,
                "error": f"Failed to mute audio: {str(e)}"
            }
    ...
    def _unmute_audio(self) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                "success": False,
                "error": f"Failed to unmute audio: {str(e)}"
            }
    ...
    def _get_volume_status(self) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                "success": False,
                "error": f"Failed to get volume status: {str(e)}"
            }
    ...
    def _get_media_status(self) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                "success": False,
                "error": f"Failed to get media status: {str(e)}"
            }
    ...
    def _launch_application(self, application: str, arguments: str = "") -> Dict[str, Any]:
        ...
        if not application:
            return {
                "success": False,
                "error": "Application name or path is required"
            }
        ...
        try:
            ...
            if self.platform == "linux":
                ...
                result = subprocess.run(
                    ["open", "-a", application] + (arguments.split() if arguments else []),
                    capture_output=True, text=True, timeout=10
                )
                if result.returncode == 0:
                    return {
            ...
            return {
                "success": False,
                "error": f"Failed to launch application: {application}",
                "platform": self.platform
            }
    ...
    def _close_application(self, application: str, force: bool = False) -> Dict[str, Any]:
        ...
        if not application:
            return {
                "success": False,
                "error": "Application name or process ID is required"
            }
        ...
        try:
            ...
            try:
                ...
                for proc in psutil.process_iter(['pid', 'name', 'cmdline']):
                    try:
                        if (application.lower() in proc.info['name'].lower() or
                            any(application.lower() in arg.lower()
                                for arg in proc.info['cmdline'] if arg)):
            ...
            return {
                ...
                "data": {
                    ...
                    "total_closed": len([p for p in closed_processes
                                       if p["action"] in ["terminated", "killed", "force_killed"]])
                }
            }
    ...
    def _get_running_applications(self, detailed: bool = False) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                "success": False,
                "error": f"Failed to get running applications: {str(e)}"
            }
    ...
    def _list_installed_applications(self, category: str = "all") -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                "success": False,
                "error": f"Failed to list installed applications: {str(e)}"
            }
    ...
    def _minimize_window(self, window_title: str) -> Dict[str, Any]:
        ...
        try:
            if self.platform == "linux":
                ...
                if shutil.which("xdotool"):
                    ...
                    if result.returncode == 0 and result.stdout.strip():
                        window_id = result.stdout.strip().split('\n')[0]
                        # Minimize the window
                        minimize_result = subprocess.run(
            ...
            return {
                "success": False,
                "error": f"Failed to minimize window: {str(e)}"
            }
    ...
    def _maximize_window(self, window_title: str) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                "success": False,
                "error": f"Failed to maximize window: {str(e)}"
            }
    ...
    def _get_window_list(self) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                "success": False,
                "error": f"Failed to get window list: {str(e)}"
            }
...
PLUGIN_METADATA = {
    ...
    "dependencies": {
        "required": ["psutil"],
        "optional": ["playerctl", "wmctrl", "xdotool", "amixer", "pactl"]
    }
}
